...
- ![Volunteer Dashboard](docs/images/placeholder_volunteer.png) *Live Crowd Heatmap & Insights*
- ![Organizer View](docs/images/placeholder_organizer.png) *Volunteer Q&A Interface*
